...
class Configs(object):
    ...
    the data is located
    """
    # the processing folder is meant to be the main folder where all the assets will exist
    # there are certain assumptions that are made about the ProcessingFolderPath
    # !!Add Assumptions!!
    # There is a slices folder present with image assets
    # There is a palettes folder present with palettes matching the images in the slices
